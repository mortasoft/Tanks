    ...
    if request.method == 'GET':
        ...
        if jugador in ("1", "2"):
            ...
            if (num_aleatorio == 0):
                ...
                return jsonify(tanque=jugador, aleatorio=num_aleatorio, accion="movimiento", direccion="izquierda",
                               x=resultado[0], y=resultado[1])
            if (num_aleatorio == 1):
                resultado = mover(str(jugador), "derecha")
                return jsonify(tanque=jugador, aleatorio=num_aleatorio, accion="movimiento", direccion="derecha",
                               x=resultado[0], y=resultado[1])
            if (num_aleatorio == 2):
                resultado = mover(str(jugador), "arriba")
                return jsonify(tanque=jugador, aleatorio=num_aleatorio, accion="movimiento", direccion="arriba",
                               x=resultado[0], y=resultado[1])
            if (num_aleatorio == 3):
                resultado = mover(str(jugador), "abajo")
                return jsonify(tanque=jugador, aleatorio=num_aleatorio, accion="movimiento", direccion="abajo",
                               x=resultado[0], y=resultado[1])
            if (num_aleatorio == 4):
                # mover(jugador, "abajo")
